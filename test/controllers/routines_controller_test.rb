...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post routines_url, params: { routine: { dom: @routine.dom, qua: @routine.qua, qui: @routine.qui, sab: @routine.sab, seg: @routine.seg, sex: @routine.sex, ter: @routine.ter } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { dom: @routine.dom, qua: @routine.qua, qui: @routine.qui, sab: @routine.sab, seg: @routine.seg, sex: @routine.sex, ter: @routine.ter } }
